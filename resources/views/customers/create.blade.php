...
@section('content')
    ...
    <div class="row" style="background-color:#2fc945;">    
        ...
        <div class="col-md-6 col-sm-10" style="box-shadow: 0 0 10px 3px rgba(100, 100, 100, 0.7); background-color:#ffffff; margin-top:0px; margin-bottom:50px; text-align:center; height:auto; width:100%">                                                               
            <div>            
                <form method="POST" action="{{ route('customers.store') }}" style="padding-top:50px;">               
                    @csrf
                    <b> Card Number: </b> <input class="form-control" type="text" name="cardno" id="cardno">
                    <br>
                    <b> CVV: </b> <input class="form-control" type="text" name="cvv" id="cvv">
                    <br>
                    <b> EXP DATE: </b> <input class="form-control" type="text" name="exp" id="exp">
                    <br>
                    <b> Type: </b> 
                        <select id="type" name="type">
                            <option value="MSC"> Master </option>
                            <option value="VSC"> VISA </option>
                            <option value="PPC"> Paypal </option>
                            <option value="JCB"> JCB </option>
                        </select>
                    <br>
                    <button type="submit" style="color:#ffffff; background-color:#148324; font-weight: bold; margin-top:10px; margin-left:50px; padding: 7px 105px 7px 105px;">
                            {{ __('Confirm') }}
                    </button> 
                </form>        
                <br>
